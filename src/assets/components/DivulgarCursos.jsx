      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center text-white">
          ...
          <p className="max-w-2xl mx-auto text-sm md:text-base text-[#f1e6de] leading-relaxed">
            Fale com nossa equipe e descubra como podemos impulsionar
            o futuro da análise de dados da sua empresa. Juntos,
            podemos transformar informação em decisões estratégicas e resultados reais.
          </p>
        </div>
        ...
        <div className="flex justify-center mt-12">
          <button className="bg-[#c9a46c] hover:bg-[#b89258] transition text-[#3d2b1f] font-medium px-10 py-3 rounded-full shadow-md">
            Fale conosco
          </button>
        </div>
      </div>
